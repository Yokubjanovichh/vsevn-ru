...
const STATIC_TEXT_FAMILY = "'Onest', sans-serif";
...
function createSvgText(text, options = {}) {
  ...
  if (options.letterSpacing)
    label.setAttribute("letter-spacing", options.letterSpacing);
...
function renderNavText(item) {
  ...
  renderElementText(textEl, {
    ...
    width:
      navTextWidths[item.dataset.tab] || measureTextWidth(text, 20, weight),
    height: 24,
    y: 18,
    weight: weight,
    useBitmapText: false,
...
function initLineCharts() {
  document.querySelectorAll(".line-chart").forEach(function (box) {
    ...
    const span = hi - lo || 1;
    const lineFrac = Math.min(
      1,
      Math.max(0, parseFloat(box.dataset.lineFrac) || 1),
    );
    ...
    if (fill)
      fill.setAttribute(
        "d",
        dLine + " L " + lineW.toFixed(1) + " " + H + " L 0 " + H + " Z",
      );
...
const REPORT_TEXT_FAMILY = "'Figtree', 'Onest', sans-serif";
...
const midTextSpecs = [
  ...
  {
    selector: ".reach-bar--yellow .bar-text",
    size: 15.5,
    weight: 300,
    color: "#FFFFFF",
    lineHeight: 19,
  ...
  {
    selector: ".reach-bar--black .bar-text",
    size: 15.5,
    weight: 300,
    color: "#FFFFFF",
    lineHeight: 19,
  ...
  {
    selector: ".reach-bar--gray .bar-text",
    size: 15.5,
    weight: 300,
    color: "#FFFFFF",
    lineHeight: 19,
  ...
  {
    // ТЗ-5-fix-3: 12.09 -> 14.09 (решение пользователя, +2px от Figma)
    selector: ".vcard-view",
    size: 14.09,
    weight: 300,
    color: "#2E2F27",
...
const RESUME_ROWS = [
  ...
  },
  {
    ...
    replyDate: "14 Нояб 2024",
    account: "Св000000001814",
  ...
  },
  {
    ...
    replyDate: "18 Нояб 2024",
    account: "Св000000001829",
    accountDate: "21 Апреля 2024",
  },
  {
    name: "Григорьева Ольга",
    phone: "89264702215",
    vacancy: "Уборщица",
    email: "grigoreva.o@gmail.com",
    replyDate: "21 Нояб 2024",
    account: "Св000000001831",
  ...
  },
  {
    ...
    accountDate: "28 Апреля 2024",
  },
  {
    name: "Егорова Мария",
    phone: "89172647853",
    vacancy: "Повар",
    email: "egorova.m@mail.ru",
    replyDate: "28 Нояб 2024",
    account: "Св000000001846",
    accountDate: "5 Мая 2024",
  },
  {
    name: "Жуков Андрей",
    phone: "89093524176",
    vacancy: "Сварщик",
    email: "zhukov.a@gmail.com",
    replyDate: "2 Дек 2024",
    account: "Св000000001852",
    accountDate: "12 Мая 2024",
  },
  {
    name: "Захаров Константин",
    phone: "89527778888",
    vacancy: "Грузчик",
    email: "zakharov.k@mail.ru",
    replyDate: "5 Дек 2024",
    account: "Св000000001857",
  ...
  },
  {
    ...
    replyDate: "9 Дек 2024",
    account: "Св000000001863",
  ...
  },
  {
    ...
    replyDate: "16 Дек 2024",
    account: "Св000000001874",
    accountDate: "9 Июня 2024",
  },
  {
    name: "Морозов Алексей",
    phone: "89086278342",
    vacancy: "Дворник",
    email: "morozov.a@yandex.ru",
    replyDate: "19 Дек 2024",
    account: "Св000000001829",
    accountDate: "21 Апреля 2024",
  },
  {
    ...
    replyDate: "23 Дек 2024",
    account: "Св000000001885",
    accountDate: "23 Июня 2024",
  },
  {
    name: "Орлов Виктор",
    phone: "89278059417",
    vacancy: "Жестянщик",
    email: "orlov.viktor@gmail.com",
    replyDate: "26 Дек 2024",
    account: "Св000000001891",
    accountDate: "30 Июня 2024",
  },
  {
    name: "Петрова Светлана",
    phone: "89113826705",
    vacancy: "Фармацевт",
    email: "petrova.s@yandex.ru",
    replyDate: "30 Дек 2024",
    account: "Св000000001898",
  ...
  },
  {
    ...
    accountDate: "14 Июля 2024",
  },
  {
    name: "Соколова Ирина",
    phone: "89067182549",
    vacancy: "Швея",
    email: "sokolova.irina@yandex.ru",
    replyDate: "7 Окт 2024",
    account: "Св000000001910",
    accountDate: "21 Июля 2024",
  },
  {
    name: "Тихонов Олег",
    phone: "89132708634",
    vacancy: "Логист",
    email: "tikhonov.o@gmail.com",
    replyDate: "14 Окт 2024",
    account: "Св000000001917",
    accountDate: "28 Июля 2024",
  },
  {
    name: "Фёдорова Ксения",
    phone: "89294617290",
    vacancy: "Инженер",
    email: "fedorova.k@mail.ru",
    replyDate: "21 Окт 2024",
    account: "Св000000001923",
    accountDate: "4 Августа 2024",
  },
  {
    name: "Харитонов Глеб",
    phone: "89028945013",
    vacancy: "Зоотехник",
    email: "kharitonov.g@yandex.ru",
    replyDate: "28 Окт 2024",
    account: "Св000000001930",
    accountDate: "11 Августа 2024",
  },
];
  ...
  if (box.children.length !== RESUME_ROWS.length) {
    ...
    RESUME_ROWS.forEach(function (row) {
      ...
      RESUME_COLS.forEach(function (col) {
        ...
        cell.style.top =
          "calc(" +
          (RESUME_ROW_BASELINE - Math.round(col.size * 0.82)) +
          " * var(--dpx, 0.0520833vw))";
        cell.style.maxWidth =
...
function renderHighlightedCellText(el, text, size, ranges) {
  ...
  // ТЗ-5: cap-коэффициент кириллицы = Arial 0.716 (был Roboto 0.711)
  ...
  ranges.forEach(function (r) {
    if (r.start > cursor)
      addSpan(text.slice(cursor, r.start), RESUME_TEXT_COLOR);
...
const PUB_ROWS = [
  {
    ...
    url: "https://ok.ru/rabotann/topic/155",
    removed: "25 Апреля 2025",
    source: "ok",
  },
  {
    vac: "Бухгалтер",
    placed: "21 Янв 2025",
    account: "Св000000001923",
    accDate: "4 Августа 2024",
    url: "https://vk.com/wall-18452_2230",
    removed: "21 Мая 2025",
    source: "vk",
  },
  {
    ...
    account: "Св000000001944",
    accDate: "20 Января 2025",
    url: "https://t.me/rabota_nn/1841",
    removed: "16 Апреля 2025",
    source: "tg",
  },
  {
    vac: "Электрик",
    placed: "9 Янв 2025",
    account: "Св000000001930",
    accDate: "11 Августа 2024",
    url: "https://rabota-nn.ru/vac/84712",
    removed: "9 Мая 2025",
    source: "site",
  },
  {
    ...
    placed: "27 Дек 2024",
    account: "Св000000001917",
    accDate: "28 Июля 2024",
    url: "https://max.ru/rabota_nn/482",
    removed: "27 Марта 2025",
    source: "max",
  },
  {
    vac: "Сварщик",
    ...
    account: "Св000000001930",
    accDate: "11 Августа 2024",
    url: "https://ok.ru/group/5279061428",
    removed: "23 Апреля 2025",
    source: "ok",
  },
  {
    vac: "Кассир",
    placed: "18 Дек 2024",
    account: "Св000000001910",
    accDate: "21 Июля 2024",
    url: "https://vk.com/wall-21043_8714",
    removed: "18 Марта 2025",
    source: "vk",
  },
  {
    vac: "Охранник",
    placed: "12 Дек 2024",
    account: "Св000000001902",
    accDate: "14 Июля 2024",
    url: "https://t.me/vakansii52/906",
    removed: "12 Апреля 2025",
    source: "tg",
  },
  {
    vac: "Администратор",
    ...
    account: "Св000000001898",
    accDate: "7 Июля 2024",
    url: "https://zarplata.ru/vacancy/3027",
    removed: "5 Марта 2025",
    source: "site",
  },
  {
    vac: "Логист",
    ...
    account: "Св000000001917",
    accDate: "28 Июля 2024",
    url: "https://ok.ru/vakansiinn/topic/87",
    removed: "28 Февраля 2025",
    source: "ok",
  },
  {
    vac: "Менеджер по продажам",
    ...
    url: "https://vk.com/wall-30287_1456",
    removed: "24 Марта 2025",
    source: "vk",
  },
  {
    vac: "Бухгалтер",
    ...
    account: "Св000000001902",
    accDate: "14 Июля 2024",
    url: "https://max.ru/vakansii52/73",
    removed: "19 Февраля 2025",
    source: "max",
  },
  {
    vac: "Водитель",
    placed: "14 Нояб 2024",
    account: "Св000000001885",
    accDate: "23 Июня 2024",
    url: "https://t.me/nn_jobs/12474",
    removed: "14 Марта 2025",
    source: "tg",
  },
  {
    vac: "Менеджер по продажам",
    ...
    url: "https://t.me/Rabota_vod/273",
    removed: "11 Февраля 2025",
    source: "tg",
  },
  {
    vac: "Повар",
    ...
    account: "Св000000001874",
    accDate: "9 Июня 2024",
    url: "https://gorodrabot.ru/job/1287",
    removed: "31 Января 2025",
    source: "site",
  },
  {
    vac: "Электрик",
    ...
    account: "Св000000001870",
    accDate: "2 Июня 2024",
    url: "https://ok.ru/rabota52/topic/301",
    removed: "27 Февраля 2025",
    source: "ok",
  },
  {
    vac: "Кассир",
    ...
    account: "Св000000001874",
    accDate: "9 Июня 2024",
    url: "https://vk.com/wall-77310_905",
    removed: "22 Января 2025",
    source: "vk",
  },
  {
    vac: "Сварщик",
    ...
    account: "Св000000001863",
    accDate: "26 Мая 2024",
    url: "https://max.ru/nn_jobs/1205",
    removed: "16 Февраля 2025",
    source: "max",
  },
  {
    vac: "Охранник",
    ...
    account: "Св000000001857",
    accDate: "19 Мая 2024",
    url: "https://trudvsem.ru/vac/55207",
    removed: "10 Января 2025",
    source: "site",
  },
  {
    vac: "Администратор",
    ...
    account: "Св000000001852",
    accDate: "12 Мая 2024",
    url: "https://ok.ru/nnvakansii/topic/12",
    removed: "30 Декабря 2024",
    source: "ok",
  },
  {
    vac: "Логист",
    ...
    account: "Св000000001846",
    accDate: "5 Мая 2024",
    url: "https://vk.com/wall-150462_388",
    removed: "25 Января 2025",
    source: "vk",
  },
  {
    vac: "Водитель",
    placed: "18 Сен 2024",
    account: "Св000000001840",
    accDate: "28 Апреля 2024",
    url: "https://t.me/trud_nino/358",
    removed: "18 Декабря 2024",
    source: "tg",
  },
  {
    vac: "Повар",
    ...
    account: "Св000000001846",
    accDate: "5 Мая 2024",
    url: "https://max.ru/trud_nn/667",
    removed: "11 Января 2025",
    source: "max",
  },
  {
    vac: "Менеджер по продажам",
    placed: "29 Авг 2024",
    account: "Св000000001831",
    accDate: "24 Апреля 2024",
    url: "https://careerist.ru/vac/90412",
    removed: "29 Декабря 2024",
    source: "site",
  },
  {
    vac: "Кассир",
    ...
    account: "Св000000001829",
    accDate: "21 Апреля 2024",
    url: "https://ok.ru/group/615047289",
    removed: "22 Ноября 2024",
    source: "ok",
  },
  {
    vac: "Бухгалтер",
    placed: "15 Авг 2024",
    account: "Св000000001814",
    accDate: "15 Апреля 2024",
    url: "https://vk.com/wall-9041_517",
    removed: "15 Декабря 2024",
    source: "vk",
  },
  {
    vac: "Электрик",
    placed: "8 Авг 2024",
    account: "Св000000001811",
    accDate: "11 Апреля 2024",
    url: "https://max.ru/job_nino/94",
    removed: "8 Ноября 2024",
    source: "max",
  },
];
  ...
  if (box.children.length !== PUB_ROWS.length) {
    ...
    PUB_ROWS.forEach(function (row) {
      ...
      PUB_COLS.forEach(function (col) {
        ...
        cell.style.top =
          "calc(" +
          (col.base - Math.round(col.size * 0.82)) +
          " * var(--dpx, 0.0520833vw))";
        cell.style.maxWidth =
          "calc(" + col.maxW + " * var(--dpx, 0.0520833vw))";
        cell.dataset.text = row[col.key];
...
function setPubMode(on) {
  ...
  if (window.history && history.replaceState) {
    history.replaceState(
      null,
      "",
      location.pathname + location.search + (on ? "#pub" : ""),
    );
  }
  initTabView();
}
...
function scrollPubTitleTop() {
  const ph =
    window.matchMedia && window.matchMedia("(max-width: 799.98px)").matches;
...
function addAccountEntry(entry) {
  ...
  accPopupControllers.forEach(function (c) {
    c.markListStale();
  });
  initAccountsPopup();
}
...
function buildAccList(list, filterSet) {
  ...
  ACCOUNTS.forEach(function (acc) {
    ...
    cb.className = "acc-cb";
    cb.innerHTML =
      '<svg viewBox="0 0 26.7 26.7" fill="none" xmlns="http://www.w3.org/2000/svg">' +
...
function layoutAccPopup(popup) {
  ...
  ACCOUNTS.forEach(function (a) {
    maxNum = Math.max(
      maxNum,
      measureTextWidth("Счёт №" + a.num, 20, 300, DASH_NAV_TEXT_FAMILY),
    );
  });
  let maxDate = 0;
  ACCOUNTS.forEach(function (a) {
    maxDate = Math.max(
      maxDate,
      measureTextWidth("от " + a.date, 20, 300, DASH_NAV_TEXT_FAMILY),
    );
  });
...
function createAccPopupController(cfg) {
  ...
  function updateScroll() {
    ...
    e.list.style.transform =
      "translateY(calc(" +
      -ctl.scrollIndex * ACC_ROW_H +
      " * var(--dpx, 0.0520833vw)))";
  ...
  function updateFilterActive() {
    const e = els();
    if (e.head)
      e.head.classList.toggle("filter-active", ctl.filterSet.size > 0);
  }
  ...
  ctl.init = function () {
    ...
    e.list.parentElement.addEventListener(
      "wheel",
      function (ev) {
        ev.preventDefault();
    ...
    e.thumb.addEventListener("mousedown", function (ev) {
      ...
      function move(mv) {
        ctl.scrollIndex =
          startIdx + Math.round((mv.clientY - startY) / (free / max));
        updateScroll();
      }
      function upFn() {
    ...
    if (e.filterX) {
      e.filterX.addEventListener("click", function () {
        ...
        if (cur.list) {
          cur.list
            .querySelectorAll(".acc-row.is-checked")
            .forEach(function (r) {
...
function truncToWidth(text, size, maxW) {
  if (measureTextWidth(text, size, 300, DASH_NAV_TEXT_FAMILY) <= maxW)
    return text;
  let t = String(text);
  while (
    t.length > 1 &&
...
function copyToClipboard(text) {
  function legacy() {
    try {
      ...
      /* буфер недоступен — молча (TODO-CLIENT) */
    }
  }
...
function initUiTipClamp() {
  ...
  document.addEventListener("mouseover", function (e) {
    ...
    const pad = 8;
    const rightEdge =
      Math.min(cardRect ? cardRect.right : Infinity, window.innerWidth) - pad;
